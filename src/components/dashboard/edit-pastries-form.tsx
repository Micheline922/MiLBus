...
type EditPastriesFormProps = {
  ...
  onSubmit: (values: { pastries: Pastry[] }) => void;
};
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 flex flex-col h-[70vh]">
        <ScrollArea className="flex-1 pr-4">
          <div className="space-y-4">
            ...
            <Button type="button" variant="outline" size="sm" onClick={() => append({ id: `pa${fields.length + 1}`, name: 'Beignets', quantity: 0, unitPrice: 0, totalPrice: 0, expenses: 0, sold: 0, remaining: 0 })}>Ajouter une pâtisserie</Button>
