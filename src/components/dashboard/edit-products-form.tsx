      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 flex flex-col h-[70vh]">
        <ScrollArea className="flex-1 pr-4">
          <div className="space-y-4">
            ...
            <Button type="button" variant="outline" size="sm" onClick={() => append({ id: `p${fields.length + 1}`, name: 'Nouveau Produit', category: 'Bijoux & Accessoires', purchasePrice: 0, price: 0, stock: 0, sold: 0, remaining: 0, profit: 0 })}>
              Ajouter un produit
            </Button>
          </div>
        </ScrollArea>
